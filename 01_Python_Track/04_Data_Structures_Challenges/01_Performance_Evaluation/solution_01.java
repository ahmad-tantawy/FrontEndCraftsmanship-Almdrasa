...
class Main {
    ...
    // Last = n, first = 2 ==> total = n * (n + 2) / 2 = n^2/2 + n/2 ==> O(n^2)
    /* 
        Time Complexity: O(n^2), Explanation: Nested loops iterate from 2 to n, checking for primes.
        Total operations are proportional to the sum of integers from 2 to n, resulting in O(n^2) based on
